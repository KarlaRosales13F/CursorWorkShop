...
Project agent skills live in `.agents/skills/`. Locked versions are recorded in `skills-lock.json` at the repo root.

- List installed skills: `npx skills list`
- Restore from lock file: `npx skills experimental_install`
- Add a skill: `npx skills add <owner/repo> --skill <name> -y`
